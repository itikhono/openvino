...
ov::pass::ConvertNMS9ToNMSIEInternal::ConvertNMS9ToNMSIEInternal() {
    ...
    auto nms = ngraph::pattern::wrap_type<ov::op::v9::NonMaxSuppression>();
    ...
    matcher_pass_callback callback = [=](pattern::Matcher& m) {
        ...
        new_score_threshold = std::make_shared<ov::op::v1::Reshape>(score_threshold, new_shape_for_score_threshold, true);
