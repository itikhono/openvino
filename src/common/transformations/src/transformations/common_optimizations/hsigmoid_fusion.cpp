...
ov::pass::HSigmoidFusionWithReluDiv::HSigmoidFusionWithReluDiv() {
    ...
    auto add = ngraph::pattern::wrap_type<ov::op::v1::Add>({input, add_constant});
    auto relu = ngraph::pattern::wrap_type<ov::op::v0::Relu>({add});
    auto min_constant = ngraph::pattern::wrap_type<ov::op::v0::Constant>();
    auto min = ngraph::pattern::wrap_type<ov::op::v1::Minimum>({relu, min_constant});
    auto div_constant = ngraph::pattern::wrap_type<ov::op::v0::Constant>();
    auto div = ngraph::pattern::wrap_type<ov::op::v1::Divide>({min, div_constant});
...
ov::pass::HSigmoidFusionWithReluMul::HSigmoidFusionWithReluMul() {
    ...
    auto mul_second = ngraph::pattern::wrap_type<ov::op::v1::Multiply>({min, mul_constant});
...
ov::pass::HSigmoidFusionWithoutRelu::HSigmoidFusionWithoutRelu() {
    ...
    auto add_constant = ngraph::pattern::wrap_type<ov::op::v0::Constant>();
    auto add = ngraph::pattern::wrap_type<ov::op::v1::Add>({input, add_constant});
    auto max_constant = ngraph::pattern::wrap_type<ov::op::v0::Constant>();
    auto max = ngraph::pattern::wrap_type<ov::op::v1::Maximum>({add, max_constant});
    auto min_constant = ngraph::pattern::wrap_type<ov::op::v0::Constant>();
    auto min = ngraph::pattern::wrap_type<ov::op::v1::Minimum>({max, min_constant});
    auto div_constant = ngraph::pattern::wrap_type<ov::op::v0::Constant>();
    auto div = ngraph::pattern::wrap_type<ov::op::v1::Divide>({min, div_constant});
    auto mul = ngraph::pattern::wrap_type<ov::op::v1::Multiply>({input, div});
...
ov::pass::HSigmoidFusionWithClampMul::HSigmoidFusionWithClampMul() {
    ...
    auto add_constant = ngraph::pattern::wrap_type<ov::op::v0::Constant>();
    auto add = ngraph::pattern::wrap_type<ov::op::v1::Add>({input, add_constant});
    auto clamp = ngraph::pattern::wrap_type<ov::op::v0::Clamp>({add});
    auto mul_constant = ngraph::pattern::wrap_type<ov::op::v0::Constant>();
    auto mul_first = ngraph::pattern::wrap_type<ov::op::v1::Multiply>({clamp, mul_constant});
...
ov::pass::HSigmoidFusionWithClampDiv::HSigmoidFusionWithClampDiv() {
    ...
    auto clamp = ngraph::pattern::wrap_type<ov::op::v0::Clamp>({add});
    auto div_constant = ngraph::pattern::wrap_type<ov::op::v0::Constant>();
    auto div = ngraph::pattern::wrap_type<ov::op::v1::Divide>({clamp, div_constant});
