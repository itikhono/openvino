...
std::shared_ptr<ov::Node> qkv_projection_block(const ov::Output<ov::Node>& input, const ov::Output<ov::Node>& weight);
...
std::shared_ptr<ov::Node> post_sdpa_proj(const ov::Output<ov::Node>& qkv);
